    ...
    <div style = "height: 100px;">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
              ...
              <a href="home.php" class="navbar-brand brand"><img src="assets/images/gech-logo.jpeg" class = "logo-image" style="height: 50px;"></a>
              <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                <li class="nav-item">
                  <a class="nav-link" href="home.php">Home</a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="appoint.php">Appoint Managers</a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="remove.php"> Remove Hostel Managers</a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="managers.php">  Hostel Managers</a>
                </li>
                <li class="nav-item ">
